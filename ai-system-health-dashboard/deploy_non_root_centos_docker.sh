...
echo "🚀 Deploying ASHD Agent to centos-docker (Non-Root)"
echo "=============================================="
...
echo "Service Status:"
ssh root@$HOST "systemctl status ashd-agent --no-pager -l | head -5"
...
echo ""
echo "Agent User:"
ssh root@$HOST "id ashd-agent"

echo ""
echo "🎯 Deployment completed!"
echo "📋 Check ASHD dashboard: http://localhost:8001"
echo "   Agent runs as non-root user: ashd-agent"
